...
public class SQLiteConnectionHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "netease.db";

    private static final int DATABASE_VERSION = 1;

    public static final String DATABASE_SQL_PATH = "ddl";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        for (int i = 0; i < changeCnt; i++) {
            String schemaName = "upgrade" + (oldVersion + i) + "_" + (oldVersion + i + 1) + ".sql";
