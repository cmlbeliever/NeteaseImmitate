package com.cml.second.app.common.widget.recyclerview;
 ...
 * HowToHeaderGridLayoutManager <com.vilyever.howtoHeaderGridLayoutManager>
...
public class HeaderGridLayoutManager extends RecyclerView.LayoutManager {
     ...
     */
    public HeaderGridLayoutManager(@Orientation int orientation, int itemLineCount) {
     ...
     */
    final HeaderGridLayoutManager self = this;
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        for (int i = 0; i < getItemCount(); i++) {
            ...
            /** 占用的块数若超过了{@link com.vilyever.howtoHeaderGridLayoutManager.HeaderGridLayoutManager.State#itemLineCount}，切换到下一line */
            if (occupiedLineBlock > self.getState().itemLineCount) {
                if (self.getState().orientation == HORIZONTAL) {
                    ...
                    offsetX = getWidth() / 3 * (i % 3); // 横向重置到0
                    if (i % 3 == 0) {
                        offsetX = 0;
                        width = getWidth();
                        offsetY += height; // 纵向偏移当前line的最大高度
                    } else {
                        offsetY += 0; // 纵向偏移当前line的最大高度
                    }
     ...
     */
    public HeaderGridLayoutManager setCanScrollHorizontal(boolean canScrollHorizontal) {
     ...
     */
    public HeaderGridLayoutManager setCanScrollVertical(boolean canScrollVertical) {
    ...
    public HeaderGridLayoutManager setOrientation(@Orientation int orientation) {
    ...
    public HeaderGridLayoutManager setItemLineCount(int itemLineCount) {
        assertNotInLayoutOrScroll(null);
